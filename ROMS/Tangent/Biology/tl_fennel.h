...
!
     ...
     &                 (z_w(i,j,k)-z_w(i,j,k-1))+                       &
     &                 (AttSW(ng)+AttChl(ng)*Bio(i,k,iChlo)+AttFac)*    &
...
!
                ...
                cff1=Bio(i,k,iChlo)/(Bio(i,k,iPhyt)*cff+eps)
                tl_cff1=(tl_Bio(i,k,iChlo)-cff1*cff*tl_Bio(i,k,iPhyt))/ &
     &                  (Bio(i,k,iPhyt)*cff+eps)
...
!
                ...
                tl_fac1=dtdays*(tl_t_PPmax*Bio(i,k,iPhyt)+              &
...
!
     ...
     &                         fac1*Bio(i,k,iChlo)/(fac2+eps)
                tl_Bio(i,k,iChlo)=tl_Bio(i,k,iChlo)+                    &
     &                            tl_fac1*Bio(i,k,iChlo)/(fac2+eps)+    &
     &                            fac1*tl_Bio(i,k,iChlo)/(fac2+eps)-    &
     &                            fac1*Bio(i,k,iChlo)/(fac2+eps)/       &
     &                            (fac2+eps)*tl_fac2
#ifdef OXYGEN
...
!
                ...
                tl_fac2=(0.5_r8+sign(0.5_r8,Bio(i,k,iOxyg)))*           &
     &                  tl_Bio(i,k,iOxyg)
                ...
                tl_fac1=dtdays*NitriR(ng)*tl_fac3
#else
                ...
                fac1=fac1*cff
                tl_fac1=tl_fac1*cff+fac1*tl_cff
#endif
                cff1=(PAR-I_thNH4(ng))/                                 &
...
# ifdef TDEPENDANCE
                ...
                cff3=cff3*cff
                tl_cff3=tl_cff3*cff+cff3*tl_cff
# endif
                Bio(i,k,iNH4_)=Bio(i,k,iNH4_)/(1.0_r8+cff3)
                tl_Bio(i,k,iNH4_)=(tl_Bio(i,k,iNH4_)-Bio(i,k,iNH4_)*    &
     &                             tl_cff3)/(1.0_r8+cff3)
...
!
          ...
          tl_fac1=fac1*tl_Bio(i,k,itemp)*LOG(ZooGR_t(ng))
          tl_cff2=cff2*tl_Bio(i,k,itemp)*LOG(PhyMR_t(ng))

          fac1=dtdays*ZooGR(ng)*fac1
          cff2=dtdays*PhyMR(ng)*cff2
          tl_fac1=dtdays*ZooGR(ng)*tl_fac1
          tl_cff2=dtdays*PhyMR(ng)*tl_cff2
#else
...
!
     ...
     &            (K_Phy(ng)+Bio(i,k,iPhyt)*Bio(i,k,iPhyt))
              cff=tl_Bio(i,k,iPhyt)/                                    &
     &            (K_Phy(ng)+Bio(i,k,iPhyt)*Bio(i,k,iPhyt))-2.0_r8*cff

              cff1=fac1*Bio(i,k,iZoop)*cff
              tl_cff1=tl_fac1*Bio(i,k,iZoop)*cff+                       &
     &                fac1*tl_Bio(i,k,iZoop)*cff+                       &
     &                fac1*Bio(i,k,iZoop)*tl_cff
              ...
              tl_Bio(i,k,iPhyt)=tl_cff3*Bio(i,k,iPhyt)+                 &
     &                          cff3*tl_Bio(i,k,iPhyt)
              tl_Bio(i,k,iChlo)=tl_cff3*Bio(i,k,iChlo)+                 &
...
!
              ...
              tl_N_Flux_Assim=(tl_cff1*Bio(i,k,iPhyt)+                  &
...
!
              cff=MAX(Bio(i,k,iPhyt)-PhyMin(ng),0.0_r8)
              tl_cff=(0.5_r8+sign(0.5_r8,Bio(i,k,iPhyt)-PhyMin(ng)))*   &
     &               tl_Bio(i,k,iPhyt)
              ...
              cff=MAX(Bio(i,k,iChlo)-ChlMin(ng),0.0_r8)
              tl_cff=(0.5_r8+sign(0.5_r8,Bio(i,k,iChlo)-ChlMin(ng)))*   &
     &               tl_Bio(i,k,iChlo)
...
# ifdef OXYGEN
     ...
     &              tl_Bio(i,1,iOxyg)
            ...
            tl_cff4=(0.5_r8+sign(0.5_r8,cff*cff1-fac3))*tl_fac3+        &
     &              (0.5_r8-sign(0.5_r8,cff*cff1-fac3))*tl_cff1*cff
